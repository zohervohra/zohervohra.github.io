        ...
        <div>
            <section className="w-full py-12 md:py-24 lg:py-32 xl:py-40 xl:flex xl:items-center xl:justify-center">
                <div className="container px-4 md:px-6">
                    <div className="flex flex-col-reverse lg:grid gap-6 lg:grid-cols-3 lg:gap-12 xl:gap-16 xl:flex-row">
                        <div className="flex flex-col justify-center space-y-4  col-span-2">
                            <div className="space-y-2">
                                <h1 className="text-2xl font-bold tracking-tighter sm:text-5xl text-white">Hello , I am <span className='text-primary' >Zoher Vohra</span></h1>
                        ...
                        <div className="flex flex-row items-center justify-center space-y-4 py-6">
                            <img
                                ...
                                // height="300"
                                alt="Hairstylist"
                                className="rounded-full border aspect-square object-cover w-40 h-40 lg:w-52 lg:h-52 xl:w-64 xl:h-64"
                            />
                        </div>
                    </div>
                </div>
